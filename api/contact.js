      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr>
          <td style="background:#ffffff;padding:32px;border-radius:0 0 12px 12px;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
            <p style="margin:0 0 16px;font-size:15px;color:#1e293b;">Olá,</p>
            <p style="margin:0 0 16px;font-size:14px;color:#475569;line-height:1.7;">Recebi sua mensagem enviada pelo site.</p>
            <p style="margin:0 0 24px;font-size:14px;color:#475569;line-height:1.7;">Em breve retornarei o contato.</p>
            <p style="margin:0;font-size:14px;color:#475569;line-height:1.7;">Obrigado,<br><strong style="color:#1e293b;">Leandro Severo</strong></p>
          </td>
        </tr>
        <tr>
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { error } = await resend.emails.send({
      from: 'Leandro Severo <contato@leandrosevero.com.br>',
      to: [toEmail],
      reply_to: cleanEmail,
  ...
  try {
    console.log('AUTO REPLY START', cleanEmail);
    const resend = new Resend(apiKey);
    const { error } = await resend.emails.send({
      from: 'Leandro Severo <contato@leandrosevero.com.br>',
      to: [cleanEmail],
